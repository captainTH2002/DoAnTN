...
import os
text_detection_model_path = os.path.abspath("text_detect_ocr/models/text_detection/epoch=43_val_total_loss=0.66.onnx")
ocr_model_path = os.path.abspath("text_detect_ocr/models/ocr/onnx_print_v4_batch8.onnx")
